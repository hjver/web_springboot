...
public class main2_aop {
	...
	/*
	 * @Before("execution(* kr.co.khj.aop.main2_controller.*(..))") public void
	 * testaop_before() { this.log.info("aop Before에서 실행되는 로그임"); }
	 */
	...
	public void testaop_a() {
		try {
			...
			int result = this.cs.log_table(this.dto);
			if (result > 0) {
	...
	@After("execution(* kr.co.khj.aop.main2_controller.testaop_logout(..))")
